...
2. Please run the tests (`$ npm test`) to make sure there are no regressions.
...
If you are working in a branch off of the 18F/about-yml-npm repo directly, you can
reference the issue like this:
`Closes #1: Short sentence describing the pull request`

If you are working in a forked copy of the repo, please reference the issue
like this:
`Closes 18F/about-yml-npm#1:  Short sentence describing the pull request`
